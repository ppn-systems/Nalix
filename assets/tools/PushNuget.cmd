...
for %%F in (..\..\src\build\bin\Release\*.nupkg) do (
    set FOUND_PACKAGE=1
    goto :UPLOAD
)
...
dotnet nuget push ..\..\src\build\bin\Release\*.nupkg --api-key %API_KEY% --source https://api.nuget.org/v3/index.json --skip-duplicate
