...
internal sealed class ReportPollingController : IReportPollingController, IAsyncDisposable
{
    ...
    private GenerationReportTarget? _activeTarget
    {
        get => _activeTargetRaw == NoTarget ? null : (GenerationReportTarget)_activeTargetRaw;
    ...
    public GenerationReportTarget? ActiveTarget => _activeTarget;
    ...
    public void Activate(GenerationReportTarget target, string route, int intervalMs)
    {
    ...
    public async Task RequestOnceAsync(GenerationReportTarget target, CancellationToken ct)
    {
