...
public static class Ed25519
{
        ...
        [System.Diagnostics.CodeAnalysis.NotNull] byte[] privateKey)
    {
        ...
        EncodePoint(mul, MemoryExtensions.AsSpan(data, 0, 32));
        aEncoded.CopyTo(MemoryExtensions.AsSpan(data, 32, PublicKeySize));
        message.CopyTo(data, 64);

        // s = (r + Hashing(data) * a) mod L
        System.Numerics.BigInteger s = (r + HashToScalar(MemoryExtensions.AsSpan(data))) * a;
        s %= s_l; // Using Mod extension below

        // CAFEBABE signature: R (32 bytes) || s (32 bytes)
        byte[] signature = new byte[SignatureSize];
        EncodePoint(mul, MemoryExtensions.AsSpan(signature, 0, 32));
        EncodeScalar(s, MemoryExtensions.AsSpan(signature, 32, 32));
        return signature;
    }
        ...
        [System.Diagnostics.CodeAnalysis.NotNull] byte[] publicKey)
    {
        ...
        Point r = DecodePoint(MemoryExtensions.AsSpan(signature, 0, 32));
        Point a = DecodePoint(publicKey);
        System.Numerics.BigInteger s = DecodeScalar(MemoryExtensions.AsSpan(signature, 32, 32));

        // Build data: R (32 bytes) || publicKey (32 bytes) || message
        byte[] data = new byte[64 + message.Length];
        MemoryExtensions.AsSpan(signature, 0, 32)
        ...
        System.Numerics.BigInteger h = HashToScalar(MemoryExtensions.AsSpan(data));
    ...
    [System.Runtime.CompilerServices.MethodImpl(
        System.Runtime.CompilerServices.MethodImplOptions.AggressiveOptimization)]
    private static System.Numerics.BigInteger ClampScalar(ReadOnlySpan<byte> s)
    {
    ...
    [System.Runtime.CompilerServices.MethodImpl(
        System.Runtime.CompilerServices.MethodImplOptions.AggressiveOptimization)]
    private static System.Numerics.BigInteger HashToScalar(ReadOnlySpan<byte> data)
    {
    ...
    [System.Runtime.CompilerServices.MethodImpl(
        System.Runtime.CompilerServices.MethodImplOptions.AggressiveOptimization)]
    private static System.Numerics.BigInteger HashToScalar(ReadOnlySpan<byte> prefix, byte[] message)
    {
    ...
    [System.Runtime.CompilerServices.MethodImpl(
        System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
    private static void EncodeScalar(System.Numerics.BigInteger s, Span<byte> destination)
    {
    ...
    [System.Runtime.CompilerServices.MethodImpl(
        System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
    private static System.Numerics.BigInteger DecodeScalar(ReadOnlySpan<byte> data)
