...
using Nalix.Examples.SDK.Commands;
using Nalix.Examples.SDK.Core;
using Nalix.Examples.SDK.UI;
using Nalix.SDK.Options;
using Spectre.Console;

namespace Nalix.Examples.SDK;
...
internal class Program
{
    ...
    private static async Task Main()
    {
        ...
        AnsiConsole.Clear();
        AnsiConsole.MarkupLine("[grey]Goodbye! [aqua]Nalix Examples SDK[/] exited cleanly.[/]");
    }
