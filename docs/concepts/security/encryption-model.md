...
> [!WARNING]
> **Security First**: By default, Nalix assumes all packets should be encrypted. Disabling encryption should only be done for high-frequency, non-sensitive data where the overhead of AEAD is a bottleneck.
