...
| Header endianness | **Defined**: header read helpers are little-endian (`ReadUInt32LittleEndian`, `ReadUInt16LittleEndian`). | `src/Nalix.Codec/Extensions/HeaderExtensions.cs` |
