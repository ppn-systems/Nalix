...
`Nalix.Common.Networking.Sessions` defines the contracts used to capture and persist resumable session state.

## Source mapping

- `src/Nalix.Common/Networking/Sessions/ISessionStore.cs`
- `src/Nalix.Common/Networking/Sessions/SessionEntry.cs`
- `src/Nalix.Common/Networking/Sessions/SessionSnapshot.cs`
