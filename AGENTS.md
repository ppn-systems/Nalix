...
This project is indexed by GitNexus as **nalix** (8924 symbols, 23012 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
