...
public interface INetworkBuilder
{
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder Configure<TOptions>(Action<TOptions> configure) where TOptions : ConfigurationLoader, new();
    ...
    /// </param>
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddPackets(Assembly assembly, bool requirePacketAttribute = false);
    ...
    /// </param>
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddPackets<TMarker>(bool requirePacketAttribute = false);
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddHandlers(Assembly assembly);
    ...
    /// <typeparam name="TMarker">A marker type used to resolve the target assembly.</typeparam>
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddHandlers<TMarker>();
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddHandler<THandler>() where THandler : class;
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddHandler<THandler>(Func<THandler> factory) where THandler : class;
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddMetadataProvider<TProvider>() where TProvider : class, IPacketMetadataProvider;
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddMetadataProvider<TProvider>(Func<TProvider> factory) where TProvider : class, IPacketMetadataProvider;
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder ConfigureDispatcher(Action<PacketDispatchOptions<IPacket>> configure);
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddTcp<TProtocol>() where TProtocol : class, IProtocol;
    ...
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddTcp<TProtocol>(Func<IPacketDispatch, TProtocol> factory) where TProtocol : class, IProtocol;
    ...
    /// <typeparam name="TProtocol">The protocol type to host.</typeparam>
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddUdp<TProtocol>() where TProtocol : class, IProtocol;
    ...
    /// <param name="factory">The factory used to create the protocol instance.</param>
    /// <returns>The current builder instance.</returns>
    INetworkBuilder AddUdp<TProtocol>(Func<IPacketDispatch, TProtocol> factory) where TProtocol : class, IProtocol;
}
