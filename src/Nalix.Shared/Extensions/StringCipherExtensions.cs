...
/// <summary>
/// Provides convenience methods to encrypt/decrypt UTF-8 text with Base64 I/O on top of <see cref="CipherSuite"/>.
/// </summary>
public static class StringCipherExtensions
{
        ...
        this System.String text, System.Byte[] key, SymmetricAlgorithmType algorithm)
    {
        ...
        System.ReadOnlyMemory<System.Byte> cipher = CipherSuite.Encrypt(utf8, key, algorithm);
        ...
        this System.String base64, System.Byte[] key, SymmetricAlgorithmType algorithm)
    {
        ...
        System.ReadOnlyMemory<System.Byte> plain = CipherSuite.Decrypt(encrypted, key, algorithm);
