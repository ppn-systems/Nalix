...
public static class HandshakeExtensions
{
        ...
        System.Threading.CancellationToken ct = default)
    {
        ...
        await client.SendAsync(new Handshake(keyPair.PublicKey, ProtocolType.TCP), ct)
    ...
    /// </summary>
    /// <param name="client">The connected <see cref="ReliableClient"/>.</param>
    /// <param name="clientKeyPair">The X25519 keypair previously generated by <see cref="InitiateHandshakeAsync(ReliableClient, System.Threading.CancellationToken)"/>.</param>
    ...
    /// </exception>
    /// <remarks>
    /// The shared secret is derived via <see cref="X25519.Agreement(System.Byte[], System.Byte[])"/> and hashed with <see cref="SHA256.HashData(System.ReadOnlySpan{System.Byte})"/>.
        ...
        IPacket packet)
    {
        ...
        try
        {
            ...
            client.Options.EncryptionKey = SHA256.HashData(secret);
