...
public static class HandshakeExtensions
{
    ...
    /// </summary>
    /// <param name="client">The connected <see cref="ReliableClient"/>.</param>
    /// <param name="clientKeyPair">The X25519 keypair previously generated by <see cref="InitiateHandshakeAsync(ReliableClient, System.UInt16, System.Threading.CancellationToken)"/>.</param>
