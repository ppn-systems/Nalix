...
/// <summary>
/// Controls the behaviour of <see cref="RequestExtensions.RequestAsync{TResponse}(ITransportSession, IPacket, RequestOptions, Func{TResponse, bool}, CancellationToken)"/>.
/// </summary>
/// <remarks>
/// <para>
