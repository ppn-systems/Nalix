...
public readonly partial struct Packet : IPacketEncryptor<Packet>
{
    ...
    static Packet IPacketEncryptor<Packet>.Encrypt(Packet packet, System.Byte[] key, EncryptionType algorithm)
        => PacketGuard.Encrypt(packet, key, algorithm);

    /// <inheritdoc />
    [System.Runtime.CompilerServices.MethodImpl(
        System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
    static Packet IPacketEncryptor<Packet>.Decrypt(Packet packet, System.Byte[] key, EncryptionType algorithm)
