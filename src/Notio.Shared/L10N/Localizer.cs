...
public sealed class Localizer
{
    ...
    /// <summary>
    /// Retrieves the localized string for the specified message ID.
    /// If no translation is found, the original ID is returned.
    /// </summary>
    /// <param name="id">The message ID.</param>
    /// <returns>
    /// The translated string if available; otherwise, the original ID.
    /// </returns>
    /// <example>
    /// <code>
    ...
    /// If no translation is found, the original ID or plural form is returned.
    /// </summary>
    /// <param name="id">The singular message ID.</param>
    /// <param name="idPlural">The plural message ID.</param>
    ...
    /// otherwise, the original ID or plural form.
    /// </returns>
    /// <example>
    /// <code>
