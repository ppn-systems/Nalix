...
internal static class Messages
{
    ...
    public static readonly string CommandIdAlreadyRegistered = "[WithHandler] Command {0} is already registered.";
    public static readonly string UnauthorizedCommandAccess = "[WithHandler] Unauthorized access to Command: {0} from {1}";
