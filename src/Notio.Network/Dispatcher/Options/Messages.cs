...
internal static class Messages
{
    ...
    public static readonly string CommandIdAlreadyRegistered = "[WithHandler] CommandId {0} is already registered.";
    public static readonly string UnauthorizedCommandAccess = "[WithHandler] Unauthorized access to CommandId: {0} from {1}";
