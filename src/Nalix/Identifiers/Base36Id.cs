...
public readonly struct Base36Id(uint value) : IIdentifier, IEquatable<Base36Id>, IComparable<Base36Id>
{
    ...
    /// <summary>
    /// Gets the HandleType encoded within this Base36Id.
    /// </summary>
    ...
    public static Base36Id NewId(HandleType type = HandleType.Unknown, ushort machineId = 0)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Base36Id FromComponents(HandleType type, ushort machineId, uint? randomValue = null)
    {
