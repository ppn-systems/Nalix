...
public readonly struct Base58Id(uint value) : IIdentifier, IEquatable<Base58Id>, IComparable<Base58Id>
{
    ...
    /// <summary>
    /// Gets the HandleType encoded within this Base58Id.
    /// </summary>
    ...
    public static Base58Id NewId(HandleType type = HandleType.Unknown, ushort machineId = 0)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Base58Id FromComponents(HandleType type, ushort machineId, uint? randomValue = null)
    {
