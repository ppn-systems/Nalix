...
public sealed partial class TaskManagerOptions : ConfigurationLoader
{
    ...
    public TimeSpan ObservingInterval { get; set; } = TimeSpan.FromSeconds(5);
    ...
    public TimeSpan CpuWarmupDuration { get; set; } = TimeSpan.FromSeconds(60);
    ...
    public TimeSpan BusyWaitThreshold { get; set; } = TimeSpan.FromTicks(2000); // 200 µs
    ...
    public TimeSpan BackoffBaseInterval { get; set; } = TimeSpan.FromSeconds(1);
