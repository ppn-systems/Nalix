...
internal static partial class TypeMetadata
{
    ...
    static TypeMetadata()
    {
        ...
        s_unsafeSizeOfMethod = typeof(System.Runtime.CompilerServices.Unsafe).GetMethod(nameof(System.Runtime.CompilerServices.Unsafe.SizeOf), BindingFlags.Public | BindingFlags.Static)!;
