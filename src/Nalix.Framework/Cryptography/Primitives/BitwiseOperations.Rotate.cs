...
internal static partial class BitwiseOperations
{
    ...
    /// </para>
    /// <para>Equivalent to: (x AND y) XOR (NOT x AND z)</para>
    /// </summary>
    ...
    /// </para>
    /// <para>Equivalent to: (x AND y) XOR (x AND z) XOR (y AND z)</para>
    /// </summary>
    ...
    /// </para>
    /// <para>Σ₀(x) = ROTR²(x) ⊕ ROTR¹³(x) ⊕ ROTR²²(x)</para>
    /// </summary>
    ...
    /// </para>
    /// <para>σ₀(x) = ROTR⁷(x) ⊕ ROTR¹⁸(x) ⊕ (x >>> 3)</para>
    /// </summary>
    /// <param name="x">The input 32-bit word.</param>
    /// <returns>The result of σ₀(x).</returns>
    [System.Runtime.CompilerServices.MethodImpl(
    ...
    /// This function performs: ROTR¹⁷(x) ⊕ ROTR¹⁹(x) ⊕ SHR¹⁰(x).
    /// </para>
    /// <para>σ₁(x) = ROTR¹⁷(x) ⊕ ROTR¹⁹(x) ⊕ (x >>> 10)</para>
    /// </summary>
    /// <param name="x">The input 32-bit word.</param>
    /// <returns>The result of σ₁(x).</returns>
    [System.Runtime.CompilerServices.MethodImpl(
