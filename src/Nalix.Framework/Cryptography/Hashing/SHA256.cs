...
public sealed class SHA256 : IShaDigest, System.IDisposable
{
    ...
    private unsafe void ProcessBlock(System.ReadOnlySpan<System.Byte> block)
    {
        ...
        fixed (System.Byte* ptr = block)
        {
            ...
            {
                w[i] = w[i - 16] + BitwiseOperations.Sigma0(w[i - 15]) + w[i - 7] + BitwiseOperations.Sigma1(w[i - 2]);
            }
        }
        ...
        var Ch = BitwiseOperations.Choose;
        var Maj = BitwiseOperations.Majority;
        var S0 = BitwiseOperations.SigmaUpper0;
        var S1 = BitwiseOperations.SigmaUpper1;
