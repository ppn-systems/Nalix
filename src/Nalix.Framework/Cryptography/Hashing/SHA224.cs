...
public sealed class SHA224 : IShaDigest, System.IDisposable
{
    ...
    private unsafe void ProcessBlock(System.ReadOnlySpan<System.Byte> block)
    {
        ...
        fixed (System.UInt32* w = _w)
        {
            ...
            {
                w[t] = BitwiseOperations.Sigma1(w[t - 2]) + w[t - 7] + BitwiseOperations.Sigma0(w[t - 15]) + w[t - 16];
            }
        }
        ...
        {
            System.UInt32 t1 = h + BitwiseOperations.SigmaUpper1(e) + BitwiseOperations.Choose(e, f, g) + SHA.K224[t] + _w[t];
            System.UInt32 t2 = BitwiseOperations.SigmaUpper0(a) + BitwiseOperations.Majority(a, b, c);
