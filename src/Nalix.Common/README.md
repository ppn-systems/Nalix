...
**Nalix.Common** defines the fundamental interfaces, protocol constants, and primitive types that all other Nalix packages depend on. It is the lowest-level building block — every module in the stack references this package.
...
For detailed API reference, see the [Nalix.Common package guide](https://ppn-systems.me/api/common/index).
