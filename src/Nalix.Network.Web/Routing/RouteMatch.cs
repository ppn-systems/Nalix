...
public sealed class RouteMatch : IReadOnlyList<string>, IReadOnlyDictionary<string, string>
{
    ...
    {
        return new(urlPath, EmptyStringList, EmptyStringList, urlPath);
    }
    ...
    {
        string? subPath = UrlPath.UnsafeStripPrefix(urlPath, baseUrlPath);
    ...
    {
        return Names.Zip(_values, (n, v) => new KeyValuePair<string, string>(n, v)).GetEnumerator();
    }
