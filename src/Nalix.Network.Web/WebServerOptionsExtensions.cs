...
public static class WebServerOptionsExtensions
{
    ...
    {
        return @this.WithUrlPrefixes(urlPrefixes as IEnumerable<string>);
    }
    ...
    /// <returns><paramref name="this"/> with its <see cref="WebServerOptions.Mode">BaseConstants</see> property
