...
public static partial class WebModuleContainerExtensions
{
    ...
    /// <param name="origins">The valid origins. Standard is <c>"*"</c>, meaning all origins.</param>
    /// <param name="headers">The valid headers. Standard is <c>"*"</c>, meaning all headers.</param>
    /// <param name="methods">The valid method. Standard is <c>"*"</c>, meaning all methods.</param>
