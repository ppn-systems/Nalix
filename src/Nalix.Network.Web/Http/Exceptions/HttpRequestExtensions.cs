...
public static class HttpRequestExtensions
{
    ...
    /// based on a request's <c>Accept-BaseConstants</c> header (or lack of it).</para>
    /// </summary>
    /// <param name="this">The <see cref="IHttpRequest"/> on which this method is called.</param>
    ...
    /// with the <c>Vary</c> header set to <c>Accept-BaseConstants</c>,
    /// so that the client may know the reason why the request has been rejected.</para>
    /// <para>If <paramref name="this"/> has no<c>Accept-BaseConstants</c> header, this method
    ...
    /// to determine whether it is a "weak" or "strong" tag. Since Notio currently generates only
    ...
    /// it works, though, with entity tags generated by Notio.</para>
    /// </remarks>
    ...
    /// <c>multipart/byteranges</c> responses is implemented in Notio, this method will ignore
