    ...
    public void PostProcessMessage(object? sender, IConnectionEventArgs args)
    {
        ...
        try
        {
            ...
            if (!this.KeepConnectionOpen)
            {
                ...
                {
                    DiagnosticsEvents.Write(DiagnosticsEvents.Internal.Trace, new DiagnosticLog("NW.Protocol:PostProcessMessage", $"disconnect id=args-connection-i-d={args.Connection.ConnectionId}"));
                }
            }
        }
