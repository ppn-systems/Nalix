...
internal sealed class StructFormatter<
    [System.Diagnostics.CodeAnalysis.DynamicallyAccessedMembers(
        ...
        System.Diagnostics.CodeAnalysis.DynamicallyAccessedMemberTypes.NonPublicFields)] T> : IFormatter<T> where T : struct
{
    #region Core Fields
    ...
    public void Serialize(ref DataWriter writer, in T value) => StructILCodec<T>.Serialize(ref writer, in value);
