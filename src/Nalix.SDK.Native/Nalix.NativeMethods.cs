...
public static class NativeMethods
{
    ...
    {
        /// <summary>
        /// The symbol name for creating a new native TCP session.
        /// </summary>
        public const string Create = "nalix_tcp_create";

        /// <summary>
        /// The symbol name for initiating a connection to a remote TCP endpoint.
        /// </summary>
        public const string Connect = "nalix_tcp_connect";

        /// <summary>
        /// The symbol name for sending data through an established TCP stream.
        /// </summary>
        public const string Send = "nalix_tcp_send";

        /// <summary>
        /// The symbol name for performing a protocol-specific handshake.
        /// </summary>
        public const string Handshake = "nalix_tcp_handshake";

        /// <summary>
        /// The symbol name for disconnect to TCP endpoint.
        /// </summary>
        public const string Disconnect = "nalix_tcp_disconnect";

        /// <summary>
        /// The symbol name for closing and releasing native TCP resources.
        /// </summary>
        ...
        {
            /// <summary>
            /// Symbol for the callback triggered upon successful connection.
            /// </summary>
            public const string OnConnected = "nalix_tcp_on_connected";

            /// <summary>
            /// Symbol for the callback triggered when a message is received.
            /// </summary>
            public const string OnMessage = "nalix_tcp_on_message";

            /// <summary>
            /// Symbol for the callback triggered when a transport error occurs.
            /// </summary>
            public const string OnError = "nalix_tcp_on_error";

            /// <summary>
            /// Symbol for the callback triggered when the session is disconnected.
            /// </summary>
