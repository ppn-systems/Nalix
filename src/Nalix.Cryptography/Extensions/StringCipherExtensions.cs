...
namespace Nalix.Cryptography.Extensions;

/// <summary>
/// Provides convenience methods to encrypt/decrypt UTF-8 text with Base64 I/O on top of <see cref="Ciphers"/>.
/// </summary>
public static class StringCipherExtensions
{
        ...
        this System.String text, System.Byte[] key, SymmetricAlgorithmType algorithm)
    {
        ...
        System.ReadOnlyMemory<System.Byte> cipher = Ciphers.Encrypt(utf8, key, algorithm);
        ...
        this System.String base64, System.Byte[] key, SymmetricAlgorithmType algorithm)
    {
        ...
        System.ReadOnlyMemory<System.Byte> plain = Ciphers.Decrypt(encrypted, key, algorithm);
