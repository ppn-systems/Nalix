...
public sealed class PBKDF2 : System.IDisposable
{
    ...
    /// <param name="iterations">The ProtocolType of iterations to perform. Must be greater than 0.</param>
    ...
    /// <param name="iterations">The ProtocolType of iterations to perform.</param>
