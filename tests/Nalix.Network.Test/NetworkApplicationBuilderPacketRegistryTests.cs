...
public sealed class NetworkApplicationBuilderPacketRegistryTests
{
    ...
    public void ConfigurePacketRegistryWhenProvidedSkipsAutomaticPacketRegistration()
    {
        ...
        PacketRegistry provided = PacketRegistry.LoadFromAssemblyPath(typeof(Network.Tests.HostingScan.HostingScanPacket).Assembly.Location, requirePacketAttribute: true);
