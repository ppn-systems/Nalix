...
Level 0 : Nalix.AutoGenerated         (Roslyn only, netstandard2.0)
Level 1 : Nalix.Environment           → Abstractions
Level 2 : Nalix.Codec                 → Abstractions, Environment, AutoGenerated (generator)
...
| [nalix-autogenerated](skills/nalix-autogenerated.md) | `Nalix.AutoGenerated` | Roslyn source generators |
