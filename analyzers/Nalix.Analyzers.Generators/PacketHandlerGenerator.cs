...
public sealed class PacketHandlerGenerator : IIncrementalGenerator
{
    ...
    private static void Execute(ImmutableArray<INamedTypeSymbol?> targets, SourceProductionContext context)
    {
        ...
        string generatedNamespace = $"{safeAssemblyName}.AutoGenerated.Handlers";
        ...
        _ = sb.AppendLine();
        _ = sb.AppendLine($"namespace {safeAssemblyName}.AutoGenerated");
        _ = sb.AppendLine("{");
        ...
        foreach (INamedTypeSymbol controller in distinctControllers)
        {
            ...
            _ = sb.AppendLine($"            global::Nalix.Runtime.Dispatching.PacketHandlerRegistry.Register(typeof({classFullName}), new global::{generatedNamespace}.{compilerName}());");
        }
