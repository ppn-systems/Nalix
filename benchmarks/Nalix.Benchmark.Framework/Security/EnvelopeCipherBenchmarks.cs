...
public class EnvelopeCipherBenchmarks : NalixBenchmarkBase
{
    ...
    public int DecryptChaCha20() { EnvelopeCipher.Decrypt(_key, GetEnvelope(CipherSuiteType.Chacha20), _decryptOut, CipherSuiteType.Chacha20, out int written, out _); return written; }

    [BenchmarkCategory("Decrypt"), Benchmark(Description = "Decrypt (ChaCha20-Poly1305)")]
    public int DecryptChaCha20Poly1305() { EnvelopeCipher.Decrypt(_key, GetEnvelope(CipherSuiteType.Chacha20Poly1305), _decryptOut, _aad, CipherSuiteType.Chacha20Poly1305, out int written, out _); return written; }

    [BenchmarkCategory("Decrypt"), Benchmark(Description = "Decrypt (Salsa20)")]
    public int DecryptSalsa20() { EnvelopeCipher.Decrypt(_key, GetEnvelope(CipherSuiteType.Salsa20), _decryptOut, CipherSuiteType.Salsa20, out int written, out _); return written; }

    [BenchmarkCategory("Decrypt"), Benchmark(Description = "Decrypt (Salsa20-Poly1305)")]
    public int DecryptSalsa20Poly1305() { EnvelopeCipher.Decrypt(_key, GetEnvelope(CipherSuiteType.Salsa20Poly1305), _decryptOut, _aad, CipherSuiteType.Salsa20Poly1305, out int written, out _); return written; }
}
