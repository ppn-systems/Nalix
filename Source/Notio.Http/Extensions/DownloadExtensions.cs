...
public static class DownloadExtensions
{
    ...
    public static async Task<string> DownloadFileAsync(this IRequest request, string localFolderPath, string localFileName = null, int bufferSize = 4096, HttpCompletionOption completionOption = HttpCompletionOption.ResponseHeadersRead, CancellationToken cancellationToken = default)
    {
    ...
    private static string GetFileNameFromPath(IRequest req)
    {
