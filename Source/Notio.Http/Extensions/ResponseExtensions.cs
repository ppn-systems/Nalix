...
/// <summary>
/// ReceiveXXX extension methods off Task&lt;IResponse&gt; that allow chaining off methods like SendAsync
...
public static class ResponseExtensions
{
    ...
    public static async Task<T> ReceiveJson<T>(this Task<IResponse> response)
    {
    ...
    public static async Task<string> ReceiveString(this Task<IResponse> response)
    {
        using var resp = await response.ConfigureAwait(false);
    ...
    public static async Task<Stream> ReceiveStream(this Task<IResponse> response)
    {
    ...
    public static async Task<byte[]> ReceiveBytes(this Task<IResponse> response)
    {
        using var resp = await response.ConfigureAwait(false);
        if (resp == null) return null;
