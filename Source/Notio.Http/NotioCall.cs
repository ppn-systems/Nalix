...
/// global event handlers and HttpException.Call.
/// </summary>
public class NotioCall
{
    /// <summary>
    /// The INotioClient used to make this call.
    /// </summary>
    public INotioClient Client { get; set; }

    /// <summary>
    /// The IRequest associated with this call.
    /// </summary>
    ...
    /// <summary>
    /// The IResponse associated with this call if the call completed, otherwise null.
    /// </summary>
    ...
    /// Otherwise null.
    /// </summary>
    public NotioRedirect Redirect { get; set; }
