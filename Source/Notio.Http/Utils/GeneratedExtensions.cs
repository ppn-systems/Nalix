...
public static class GeneratedExtensions
{
    ...
    public static Url AppendPathSegment(this string url, object segment, bool fullyEncode = false)
        => new Url(url).AppendPathSegment(segment, fullyEncode);
    ...
    public static Url AppendPathSegments(this string url, params object[] segments)
        => new Url(url).AppendPathSegments(segments);
    ...
    /// <param name="url">This URL.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemovePathSegment(this string url) => new Url(url).RemovePathSegment();
    ...
    /// <param name="url">This URL.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemovePath(this string url) => new Url(url).RemovePath();
    ...
    public static Url SetQueryParam(this string url, string name, object value, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(url).SetQueryParam(name, value, nullValueHandling);
    ...
    public static Url SetQueryParam(this string url, string name, string value, bool isEncoded = false, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(url).SetQueryParam(name, value, isEncoded, nullValueHandling);
    ...
    /// <param name="name">Name of query parameter</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url SetQueryParam(this string url, string name) => new Url(url).SetQueryParam(name);
    ...
    public static Url SetQueryParams(this string url, object values, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(url).SetQueryParams(values, nullValueHandling);
    ...
    /// <returns>A new Flurl.Url object.</returns>
    public static Url SetQueryParams(this string url, IEnumerable<string> names) => new Url(url).SetQueryParams(names);
    ...
    /// <param name="names">Names of query parameters</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url SetQueryParams(this string url, params string[] names) => new Url(url).SetQueryParams(names);
    ...
    public static Url AppendQueryParam(this string url, string name, object value, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(url).AppendQueryParam(name, value, nullValueHandling);
    ...
    public static Url AppendQueryParam(this string url, string name, string value, bool isEncoded = false, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(url).AppendQueryParam(name, value, isEncoded, nullValueHandling);
    ...
    /// <param name="name">Name of query parameter</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url AppendQueryParam(this string url, string name) => new Url(url).AppendQueryParam(name);
    ...
    public static Url AppendQueryParam(this string url, object values, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(url).AppendQueryParam(values, nullValueHandling);
    ...
    /// <param name="names">Names of query parameters.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url AppendQueryParam(this string url, IEnumerable<string> names) => new Url(url).AppendQueryParam(names);
    ...
    /// <param name="names">Names of query parameters</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url AppendQueryParam(this string url, params string[] names) => new Url(url).AppendQueryParam(names);
    ...
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveQueryParam(this string url, string name) => new Url(url).RemoveQueryParam(name);
    ...
    public static Url RemoveQueryParams(this string url, params string[] names)
        => new Url(url).RemoveQueryParams(names);
    ...
    /// <param name="names">Query string parameter names to remove</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveQueryParams(this string url, IEnumerable<string> names) => new Url(url).RemoveQueryParams(names);
    ...
    /// <param name="url">This URL.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveQuery(this string url) => new Url(url).RemoveQuery();
    ...
    /// <returns>A new Flurl.Url object.</returns>
    public static Url SetFragment(this string url, string fragment) => new Url(url).SetFragment(fragment);
    ...
    /// <param name="url">This URL.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveFragment(this string url) => new Url(url).RemoveFragment();
    ...
    /// <param name="url">This URL.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url ResetToRoot(this string url) => new Url(url).ResetToRoot();
    ...
    public static Url AppendPathSegment(this Uri uri, object segment, bool fullyEncode = false)
        => new Url(uri).AppendPathSegment(segment, fullyEncode);
    ...
    public static Url AppendPathSegments(this Uri uri, params object[] segments)
        => new Url(uri).AppendPathSegments(segments);
    ...
    /// <param name="uri">This System.Uri.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemovePathSegment(this Uri uri) => new Url(uri).RemovePathSegment();
    ...
    /// <param name="uri">This System.Uri.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemovePath(this Uri uri) => new Url(uri).RemovePath();
    ...
    public static Url SetQueryParam(this Uri uri, string name, object value, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(uri).SetQueryParam(name, value, nullValueHandling);
    ...
    public static Url SetQueryParam(this Uri uri, string name, string value, bool isEncoded = false, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(uri).SetQueryParam(name, value, isEncoded, nullValueHandling);
    ...
    /// <param name="name">Name of query parameter</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url SetQueryParam(this Uri uri, string name) => new Url(uri).SetQueryParam(name);
    ...
    public static Url SetQueryParams(this Uri uri, object values, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(uri).SetQueryParams(values, nullValueHandling);
    ...
    /// <param name="names">Names of query parameters.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url SetQueryParams(this Uri uri, IEnumerable<string> names) => new Url(uri).SetQueryParams(names);
    ...
    /// <param name="names">Names of query parameters</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url SetQueryParams(this Uri uri, params string[] names) => new Url(uri).SetQueryParams(names);
    ...
    public static Url AppendQueryParam(this Uri uri, string name, object value, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(uri).AppendQueryParam(name, value, nullValueHandling);
    ...
    public static Url AppendQueryParam(this Uri uri, string name, string value, bool isEncoded = false, NullValueHandling nullValueHandling = NullValueHandling.Remove)
        => new Url(uri).AppendQueryParam(name, value, isEncoded, nullValueHandling);
    ...
    /// <param name="name">Name of query parameter</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url AppendQueryParam(this Uri uri, string name) => new Url(uri).AppendQueryParam(name);
    ...
    /// <param name="nullValueHandling">Indicates how to handle null values. Defaults to Remove (any existing)</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url AppendQueryParam(this Uri uri, object values, NullValueHandling nullValueHandling = NullValueHandling.Remove) => new Url(uri).AppendQueryParam(values, nullValueHandling);
    ...
    /// <param name="names">Names of query parameters.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url AppendQueryParam(this Uri uri, IEnumerable<string> names) => new Url(uri).AppendQueryParam(names);
    ...
    /// <param name="names">Names of query parameters</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url AppendQueryParam(this Uri uri, params string[] names) => new Url(uri).AppendQueryParam(names);
    ...
    /// <param name="name">Query string parameter name to remove</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveQueryParam(this Uri uri, string name) => new Url(uri).RemoveQueryParam(name);
    ...
    /// <param name="names">Query string parameter names to remove</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveQueryParams(this Uri uri, params string[] names) => new Url(uri).RemoveQueryParams(names);
    ...
    /// <param name="names">Query string parameter names to remove</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveQueryParams(this Uri uri, IEnumerable<string> names) => new Url(uri).RemoveQueryParams(names);
    ...
    /// <param name="uri">This System.Uri.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveQuery(this Uri uri) => new Url(uri).RemoveQuery();
    ...
    /// <param name="fragment">The part of the URL after #</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url SetFragment(this Uri uri, string fragment) => new Url(uri).SetFragment(fragment);
    ...
    /// <param name="uri">This System.Uri.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url RemoveFragment(this Uri uri) => new Url(uri).RemoveFragment();
    ...
    /// <param name="uri">This System.Uri.</param>
    /// <returns>A new Flurl.Url object.</returns>
    public static Url ResetToRoot(this Uri uri) => new Url(uri).ResetToRoot();
}