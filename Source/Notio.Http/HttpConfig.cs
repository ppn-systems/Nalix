...
public sealed class HttpConfig : ConfigurationBinder
{
    ...
    /// Default is 100.
    /// </summary>
    public int MaxConcurrentRequests { get; private set; } = 100;

    /// <summary>
    /// Gets the maximum size of a request in bytes.
    /// Default is 100 MB.
    /// </summary>
    public int MaxRequestSize { get; private set; } = 100 * 1024 * 1024; // 100MB
    ...
    /// Default is true.
    /// </summary>
    public bool RequireHttps { get; private set; } = false;

    /// <summary>
    /// Gets the server's base URL.
    /// Default is "http://localhost".
    /// </summary>
    public string UniformResourceLocator { get; } = "http://localhost";
    ...
    /// </summary>
    public string CertPemFilePath { get; private set; }
    ...
    public string KeyPemFilePath { get; private set; }
    ...
    /// </summary>
    [ConfigurationIgnore]
    public TimeSpan CacheExpiration { get; private set; } = TimeSpan.FromMinutes(10);
}