...
public class HttpCallAssertion
{
    ...
    private IList<NotioCall> _calls;
    ...
    /// </summary>
    /// <param name="match">Predicate (usually a lambda expression) that tests a NotioCall and returns a bool.</param>
    /// <param name="descrip">A description of what is being asserted.</param>
    public HttpCallAssertion With(Func<NotioCall, bool> match, string descrip = null)
    {
    ...
    /// <param name="match">Predicate (usually a lambda expression) that tests a NotioCall and returns a bool.</param>
    /// <param name="descrip">A description of what is being asserted.</param>
    public HttpCallAssertion Without(Func<NotioCall, bool> match, string descrip = null)
    {
