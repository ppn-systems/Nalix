...
{
    internal static bool HasAnyVerb(this NotioCall call, HttpMethod[] verbs)
    {
        // for good measure, check both Request.Verb and HttpRequestMessage.Method
        return verbs.Any(verb => call.Request.Verb == verb && call.HttpRequestMessage.Method == verb);
    }

    internal static bool HasAnyVerb(this NotioCall call, string[] verbs)
    {
        // for good measure, check both Request.Verb and HttpRequestMessage.Method
    ...
    /// </summary>
    internal static bool HasQueryParam(this NotioCall call, string name, object value = null)
    {
        if (value == null)
    ...
    internal static bool HasAllQueryParams(this NotioCall call, string[] names)
    {
    ...
    internal static bool HasAnyQueryParam(this NotioCall call, string[] names)
    {
    ...
    internal static bool HasQueryParams(this NotioCall call, object values)
    {
    ...
    /// null value means just check for existence by name
    /// </summary>
    internal static bool HasHeader(this NotioCall call, string name, object value = null)
    {
        return value == null ?
    ...
    /// null value means just check for existence by name
    /// </summary>
    internal static bool HasCookie(this NotioCall call, string name, object value = null)
    {
        return value == null ?
