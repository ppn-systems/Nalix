...
namespace Notio.Http.Interfaces
{
    ...
    {
        /// <summary>
        /// Change HttpSettings for this request, client, or test context.
        /// </summary>
        ...
        public static T WithSettings<T>(this T obj, Action<HttpSettings> action) where T : ISettingsContainer
        {
            action(obj.Settings);
            return obj;
        }
        ...
        /// <summary>
        /// Adds a pattern representing an HTTP status code or range of codes which (in addition to 2xx) will NOT result in a HttpException being thrown.
        /// </summary>
        /// <param name="obj">Object containing settings.</param>
        ...
        /// <summary>
        /// Adds one or more response status codes which (in addition to 2xx) will NOT result in a HttpException being thrown.
        /// </summary>
        /// <param name="obj">Object containing settings.</param>
        ...
        /// <summary>
        /// Prevents a HttpException from being thrown on any completed response, regardless of the HTTP status code.
        /// </summary>
        /// <param name="obj">Object containing settings.</param>
        /// <returns>This settings container.</returns>
