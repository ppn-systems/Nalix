using NotioIO.Routing;
using NotioIO.Sessions;
using NotioIO.Utilities;
using NotioIO.WebSockets;
using System;
...
{
    /// <summary>
    /// <para>Represents a HTTP context implementation, i.e. a HTTP context as seen internally by NotioIO.</para>
    /// <para>This API mainly supports the NotioIO infrastructure; it is not intended to be used directly from your code,
    /// unless to address specific needs in the implementation of NotioIO plug-ins (e.g. modules).</para>
    /// </summary>
    ...
    public interface IHttpContextImpl : IHttpContext
    {
        ...
        /// <para>This API supports the NotioIO infrastructure and is not intended to be used directly from your code.</para>
        /// </summary>
