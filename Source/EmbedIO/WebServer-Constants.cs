...
public partial class WebServer
{
    ...
    /// </summary>
    public static readonly string Signature = "NotioIO/" + Assembly.GetExecutingAssembly().GetCustomAttributes<AssemblyInformationalVersionAttribute>().First().InformationalVersion;
