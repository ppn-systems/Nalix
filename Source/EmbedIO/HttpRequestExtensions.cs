...
namespace NotioIO
{
    ...
    public static class HttpRequestExtensions
    {
        ...
        /// to determine whether it is a "weak" or "strong" tag. Since NotioIO currently generates only
        ...
        /// it works, though, with entity tags generated by NotioIO.</para>
        /// </remarks>
        ...
        /// <c>multipart/byteranges</c> responses is implemented in NotioIO, this method will ignore
        ...
        public static bool IsRangeRequest(this IHttpRequest @this, long contentLength, string entityTag, DateTime lastModifiedUtc, out long start, out long upperBound)
        {
            ...
            // NotioIO does not support multipart/byteranges responses (yet),
