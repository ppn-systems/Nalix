...
/// </summary>
internal sealed class ConfigIniFile
{
    ...
    /// <summary>
    /// Khởi tạo một phiên bản mới của <see cref="ConfigIniFile"/> cho đường dẫn được chỉ định.
    /// </summary>
    /// <param name="path">Đường dẫn tới tệp ini.</param>
    public ConfigIniFile(string path)
    {
        _path = path;
        _iniData = [];
        Load();
    ...
    /// <summary>
    /// Lấy giá trị có khóa được chỉ định từ phần được chỉ định của <see cref="ConfigIniFile"/> này dưới dạng <see cref="bool"/>.
    /// </summary>
    /// <param name="section">Tên phần trong tệp ini.</param>
    /// <param name="key">Tên khóa trong phần.</param>
    ...
    /// <summary>
    /// Lấy giá trị có khóa được chỉ định từ phần được chỉ định của <see cref="ConfigIniFile"/> này dưới dạng <see cref="int"/>.
    /// </summary>
    /// <param name="section">Tên phần trong tệp ini.</param>
    /// <param name="key">Tên khóa trong phần.</param>
    ...
    /// <summary>
    /// Lấy giá trị có khóa được chỉ định từ phần được chỉ định của <see cref="ConfigIniFile"/> này dưới dạng <see cref="uint"/>.
    /// </summary>
    /// <param name="section">Tên phần trong tệp ini.</param>
    /// <param name="key">Tên khóa trong phần.</param>
    ...
    /// <summary>
    /// Lấy giá trị có khóa được chỉ định từ phần được chỉ định của <see cref="ConfigIniFile"/> này dưới dạng <see cref="long"/>.
    /// </summary>
    /// <param name="section">Tên phần trong tệp ini.</param>
    /// <param name="key">Tên khóa trong phần.</param>
    ...
    /// <summary>
    /// Lấy giá trị có khóa được chỉ định từ phần được chỉ định của <see cref="ConfigIniFile"/> này dưới dạng <see cref="ulong"/>.
    /// </summary>
    /// <param name="section">Tên phần trong tệp ini.</param>
    /// <param name="key">Tên khóa trong phần.</param>
    ...
    /// <summary>
    /// Lấy giá trị có khóa được chỉ định từ phần được chỉ định của <see cref="ConfigIniFile"/> này dưới dạng <see cref="float"/>.
    /// </summary>
    /// <param name="section">Tên phần trong tệp ini.</param>
    /// <param name="key">Tên khóa trong phần.</param>
