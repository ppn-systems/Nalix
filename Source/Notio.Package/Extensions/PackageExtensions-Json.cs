...
public static partial class PackageExtensions
{
    ...
    /// <exception cref="PackageException">Ném lỗi khi JSON serialization thất bại.</exception>
    ...
    /// <exception cref="PackageException">Ném lỗi khi JSON không hợp lệ hoặc không thể deserialization.</exception>
    public static Packet FromJson(this string json, JsonSerializerOptions? options = null)
    {
        ...
        try
        {
            ...
            return packet ?? throw new PackageException("Deserialized packet is null.");
        }
        catch (Exception ex)
        {
