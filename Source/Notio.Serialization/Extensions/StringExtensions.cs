...
internal static class StringExtensions
{
    ...
    internal static string? ToStringInvariant(this object? @this)
    {
        if (@this == null)
            return string.Empty;
    ...
    internal static string Slice(this string @this, int startIndex, int endIndex)
    {
        if (@this == null)
            return string.Empty;
    ...
    /// <returns>Retrieves a substring from this instance.</returns>
    internal static string SliceLength(this string @this, int startIndex, int length)
    {
        if (@this == null)
            return string.Empty;
    ...
    internal static Tuple<int, int> TextPositionAt(this string value, int charIndex)
    {
        if (value == null)
