...
public class CsvReader : IDisposable
{
    ...
    /// <exception cref="EndOfStreamException">Cannot read past the end of the stream.</exception>
    ...
    #endregion Generic, Main ReadLine method
    ...
    /// <exception cref="InvalidOperationException">ReadHeadings.</exception>
    /// <exception cref="EndOfStreamException">Cannot read past the end of the stream.</exception>
    ...
    /// <exception cref="ArgumentNullException">map
    /// or
    /// result.</exception>
    /// <exception cref="InvalidOperationException">ReadHeadings.</exception>
    /// <exception cref="EndOfStreamException">Cannot read past the end of the stream.</exception>
