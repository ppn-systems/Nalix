...
public partial class WebServer
{
    ...
    /// </summary>
    public static readonly string Signature = "Notio/" + Assembly.GetExecutingAssembly().GetCustomAttributes<AssemblyInformationalVersionAttribute>().First().InformationalVersion;
